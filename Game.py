...
def die(screen, score):
    ...
    records = conn.execute("select score from highscore order by score desc limit 10")
    highscores = list(records.fetchall())
    highscores = [0]
    if score > 0:
        if not highscores:
            enter_name()
        elif highscores and score >= int(highscores[-1]):
            enter_name()
    conn.commit()
    cap.release()
    pygame.display.quit()
...
def game():
    ...
    while (cap.isOpened()):
        ...
        while i >= 2:
            ...
            i -= 1
        if collide(xs1[0], applepos1[0], ys1[0], applepos1[1], 20, 10, 20, 10): score1 += 1;xs1.append(700);ys1.append(
            700);applepos1 = (random.randint(0, 590), random.randint(0, 590))
        ...
        s1.blit(appleimage1, applepos1);
        t1 = f1.render(str(score1), True, (255, 255, 255));
        s1.blit(t1, (10, 10));
        pygame.display.update()
...
def highscore():
    ...
    l = Label(root, text='NAME', bd=3, relief='solid', padx=180, pady=30, font=("Arial", 20), width=20,
              background='#000000', foreground='red')
    l.place(x=270, y=00)

    l2 = Label(root, text='SCORE', bd=3, relief='solid', padx=155, pady=30, font=("Arial", 20), width=9,
               background='#000000', foreground='red')
    l2.place(x=840, y=00)
...
def help_func():
    ...
    l5 = Label(root, text='NAVIGATION', bd=3, relief='solid', padx=400, pady=70, font=("Arial", 70), width=9,
               background='#000000', foreground='red')
    l5.place(x=0, y=0)
    a1 = Label(root, text='1. SHOW 2 FINGERS TO GO UP', bd=3, relief='solid', padx=600, pady=30, font=("Arial", 20),
               width=9, background='#000000', foreground='red')
    a1.place(x=0, y=240)
    a2 = Label(root, text='2. SHOW 3 FINGERS TO GO DOWN', bd=3, relief='solid', padx=600, pady=30, font=("Arial", 20),
               width=9, background='#000000', foreground='red')
    a2.place(x=0, y=320)
    a3 = Label(root, text='3. SHOW 4 FINGERS TO GO LEFT', bd=3, relief='solid', padx=600, pady=30, font=("Arial", 20),
               width=9, background='#000000', foreground='red')
    a3.place(x=0, y=400)
    a4 = Label(root, text='4. SHOW 5 FINGERS TO GO RIGGHT', bd=3, relief='solid', padx=600, pady=30, font=("Arial", 20),
               width=9, background='#000000', foreground='red')
    a4.place(x=0, y=480)

    hel = Button(root, text='BACK TO MAIN MENU', font=("Arial", 50), fg='black', padx=300, pady=30, command=menu,
                 background='#000000', foreground='red')
    hel.place(x=0, y=560)
...
def menu():
    ...
    menu = Button(root, text='HIGH SCORE', fg='black', padx=60, pady=20, command=highscore, background='#000000',
                  foreground='red', bd=10, relief='raised')
    menu.place(x=600, y=220)
    hel = Button(root, text='HELP', fg='black', padx=80, pady=20, command=help_func, background='#000000',
                 foreground='red', bd=10, relief='raised')
    hel.place(x=600, y=320)
    demo = Button(root, text='DEMO', fg='black', padx=80, pady=15, command=play, background='#000000', foreground='red',
                  bd=10, relief='raised')
    demo.place(x=600, y=420)
    ex = Button(root, text='BACK', fg='black', padx=80, pady=20, command=back, background='#000000', foreground='red',
                bd=10, relief='raised')
...
def main_menu():
    ...
    ga = Button(root, text='GAME', fg='black', command=menu, padx=100, pady=20, background='#000000', foreground='red',
                bd=10, relief='groove')
    ga.place(x=600, y=300)
    ex = Button(root, text='EXIT', fg='black', padx=100, pady=20, command=exit_func, background='#000000',
                foreground='red', bd=10, relief='groove')
